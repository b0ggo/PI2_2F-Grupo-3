  ...
  return (
    <div className="consultar-page">
      <header className="consultar-header">
        <h1 className="consultar-title">Buscar</h1>
        <p className="consultar-sub">
          Encontre animais, lotes ou registros pelo código ou nome.
        </p>
        <label className="consultar-search-label" htmlFor="busca-global">
          <span className="consultar-search-wrap">
            <svg
              className="consultar-search-icon"
              width="20"
              height="20"
              viewBox="0 0 24 24"
              fill="none"
